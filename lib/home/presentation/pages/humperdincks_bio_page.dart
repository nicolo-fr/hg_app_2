...
class HumperdincksBioPage extends StatelessWidget {
  const HumperdincksBioPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const ArticlePageLayout(
      imagePath: 'assets/images/humperdincks.png',
      title: 'La fratrie Humperdinck',
      children: [
